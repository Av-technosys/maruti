          ...
          <div className=" py-4">
            ...
            <div className=" grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6 w-full px-4 ">
              <FileUpload
                ...
                docName="panCard"
                onUploaded={(value) =>
                  setUserData((prev) => ({ ...prev, linkPanUnitHolder: value }))
                }
              />
              <FileUpload
                userId={userData.id}
          ...
          <div className=" py-4">
            <div className="  flex flex-col sm:flex-row gap-6 w-full px-4 py-4 ">
              ...
              <DatePicker
                ...
                value={JSON.parse(userData.dateOfLeaveAndLicenceDocumentLessee)}
                setValue={(e) =>
                  setUserData((prev) => ({
                    ...prev,
            ...
            <div className="  flex flex-col sm:flex-row gap-6 w-full px-4 py-4 ">
              <DatePicker
                ...
                setValue={(e) =>
                  setUserData((prev) => ({
                    ...prev,
                    validityOfLeaseAndLicenseDocumentLessee: JSON.stringify(e),
                  }))
                }
              />
              <InputText
